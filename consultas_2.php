...
$sql= "SELECT * FROM SAPROD WHERE Existen <> 0 and Descrip like ('%$criterio%')  or Descrip2   like ('%$criterio%')  or Descrip3   like ('%$criterio%') or CodProd like ('%$criterio%') or Refere like ('%$criterio%') order by Existen desc "
...
while ($row = sqlsrv_fetch_array ($result)){
  ...
  echo '<tr>';echo '<td>'; echo $CodProd; echo '<td>'; echo $Descrip; echo '<td>'; echo $Precio3; echo '<td algin = center>'; echo  '<center>'.$Existen;
}
